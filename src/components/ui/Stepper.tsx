...
export default function Stepper({
  ...
  return (
    <div className="stepper-outer" {...(rest as React.HTMLAttributes<HTMLDivElement>)}>
...
function StepIndicator({ step, currentStep, onClickStep, disableStepIndicators }: StepIndicatorProps) {
  ...
  return (
    ...
    >
      <motion.div
        variants={{
          inactive: { scale: 1, backgroundColor: '#1a1a1a', color: '#555' },
          active:   { scale: 1, backgroundColor: '#00FFE0', color: '#000' },
          complete: { scale: 1, backgroundColor: '#00FFE0', color: '#000' },
        }}
    ...
    <div className="step-connector">
      <motion.div
        ...
        variants={{
          ...
          complete: { width: '100%', backgroundColor: '#00FFE0' },
        }}
        initial={false}
